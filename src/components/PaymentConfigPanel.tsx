...
import { CreditCard, Key, ShieldCheck, Check, AlertCircle, Save, Eye, EyeOff, ExternalLink } from 'lucide-react';
    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xs space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3 pb-4 border-b border-slate-100">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 bg-blue-50 border border-blue-100 text-blue-600 rounded-2xl flex items-center justify-center font-bold">
            <CreditCard className="h-5 w-5" />
          </div>
          <div>
            <h3 className="font-extrabold text-sm text-slate-900">Configuración Pasarela de Pago (Mercado Pago)</h3>
      ...
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div className="flex items-center justify-between bg-slate-50 p-4 rounded-2xl border border-slate-200">
          <div>
            <span className="font-bold text-xs text-slate-800 block">Habilitar Cobro Online por Mercado Pago</span>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-3 pr-10 py-2.5 bg-slate-50 border border-slate-250 rounded-xl text-xs font-mono text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="button"
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 bg-slate-50 border border-slate-250 rounded-xl text-xs font-mono text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <span className="text-[10px] text-slate-400 font-medium mt-1 block">
        ...
        <button
          type="submit"
          disabled={isSaving}
          className="bg-blue-600 hover:bg-blue-700 text-white font-extrabold px-6 py-2.5 rounded-xl text-xs flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer disabled:opacity-50"
        >
