...
import { ShieldCheck, ArrowLeft, Pill, Lock, FileText, CheckCircle } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
        ...
        <div className="bg-slate-900 text-white p-6 flex justify-between items-center border-b border-slate-800">
          <div className="flex items-center gap-3">
            <div className="bg-[#2997C6] text-white p-2 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium">Mi Receta Online — Documento Oficial</p>
            </div>
          </div>
          <button 
            onClick={onClose}
            className="text-slate-400 hover:text-white p-2 rounded-lg hover:bg-slate-800 transition-colors font-bold text-lg"
          >
            ✕
          </button>
        </div>
        ...
        {/* Content Area */}
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-sm text-slate-700 leading-relaxed font-medium">
          
          {type === 'privacidad' && (
            <>
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-blue-900 flex items-start gap-3">
                <ShieldCheck className="h-5 w-5 text-[#2997C6] shrink-0 mt-0.5" />
                <p className="text-xs">
                  Tus datos personales y de salud están estrictamente encriptados y protegidos bajo la <strong>Ley N° 25.326 de Protección de Datos Personales</strong> de la República Argentina y secreto médico profesional.
                </p>
              </div>

              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">1. Recolección de Datos Clínicos</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">2. Secreto Médico y Confidencialidad</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">3. Seguridad Técnica</h4>
                <p>
          ...
          {type === 'terminos' && (
            <>
              <div className="bg-slate-100 border border-slate-200 rounded-xl p-4 text-slate-800 flex items-start gap-3">
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">1. Alcance de la Plataforma</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">2. Emergencias y Urgencias</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">3. Prescripción y Firma Digital</h4>
                <p>
          ...
          {type === 'arrepentimiento' && (
            <>
              <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4 text-emerald-900 flex items-start gap-3">
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-base text-slate-900">Botón de Arrepentimiento</h4>
                <p>
              ...
              <section className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
                <h5 className="font-bold text-slate-900 text-sm">¿Cómo solicitar tu reembolso?</h5>
        ...
        <div className="bg-slate-50 border-t border-slate-200 p-4 sm:px-6 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-2.5 rounded-xl text-sm transition-colors cursor-pointer"
          >
            Entendido
          </button>
        </div>
